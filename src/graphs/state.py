...
class GraphInput(BaseModel):
    ...
    grok_api_key: str = Field(default="", repr=False, description="运行时可选的 Grok API Key")
    openai_api_key: str = Field(default="", repr=False, description="运行时可选的 OpenAI API Key")
...
class ProcessNodeInput(BaseModel):
    ...
    niche: str = Field(default="", description="领域")
    audience: str = Field(default="小红书新手用户", description="目标人群")
    demand_insights: List[DemandInsight] = Field(default_factory=list, description="需求洞察")
    topic_research_notes: List[str] = Field(default_factory=list, description="选题证据")
    benchmark_notes: List[str] = Field(default_factory=list, description="对标素材")
    user_selected_topic: str = Field(default="", description="用户指定选题")
...
class SkillSubflowNodeInput(BaseModel):
    ...
    selected_topic: TopicRecord = Field(default_factory=lambda: TopicRecord(title="", audience="", hook="", demand_source="", differentiation=""))
    audience: str = Field(default="小红书新手用户", description="目标人群")
    brand_voice: str = Field(default="清醒、实操、少废话", description="账号语气")
    openai_text_model: str = Field(default="gpt-5.5", description="OpenAI 文案模型")
    openai_reasoning_mode: str = Field(default="ultra_high", description="OpenAI 推理模式")
    ...
    image_aspect_ratio: str = Field(default="3:4", description="图片比例")
    image_style: str = Field(default="cartoon", description="图片风格")
    skill_flow_overrides: Dict[str, Any] = Field(default_factory=dict, description="子流程覆盖")
    prompt_overrides: Dict[str, str] = Field(default_factory=dict, description="提示词覆盖")
...
class PromptNodeInput(BaseModel):
    ...
    selected_topic: TopicRecord = Field(default_factory=lambda: TopicRecord(title="", audience="", hook="", demand_source="", differentiation=""))
    prompt_overrides: Dict[str, str] = Field(default_factory=dict, description="提示词覆盖")
    skill_subflows: List[SkillSubflow] = Field(default_factory=list, description="子流程列表")
    openai_text_model: str = Field(default="gpt-5.5", description="OpenAI 模型")
    grok_image_model: str = Field(default="grok-imagine-image-quality", description="Grok 模型")
...
class OpenAITextNodeInput(BaseModel):
    ...
    niche: str = Field(default="", description="领域")
    openai_text_model: str = Field(default="gpt-5.5", description="OpenAI 模型")
    openai_reasoning_mode: str = Field(default="ultra_high", description="推理模式")
    card_count: int = Field(default=6, description="卡片页数")
    image_aspect_ratio: str = Field(default="3:4", description="图片比例")
    image_style: str = Field(default="cartoon", description="图片风格")
    editable_prompts: List[EditablePrompt] = Field(default_factory=list, description="可编辑提示词")
    skill_subflows: List[SkillSubflow] = Field(default_factory=list, description="子流程")
    execute_model_calls: bool = Field(default=False, description="是否真实调用")
    openai_api_key: str = Field(default="", repr=False, description="OpenAI API Key")
    constraints: List[str] = Field(default_factory=list, description="限制条件")
    goal: str = Field(default="", description="本轮目标")
    brand_voice: str = Field(default="", description="账号语气")
...
class GrokImageNodeInput(BaseModel):
    ...
    image_style_rules: ImageStyleRule = Field(default_factory=ImageStyleRule, description="图片风格规则")
    openai_text_package: TextDescriptionPackage = Field(default_factory=TextDescriptionPackage, description="OpenAI 文案包")
    skill_subflows: List[SkillSubflow] = Field(default_factory=list, description="子流程")
    grok_image_model: str = Field(default="grok-imagine-image-quality", description="Grok 模型")
    grok_image_mode: str = Field(default="Expert", description="Grok 模式")
    image_aspect_ratio: str = Field(default="3:4", description="图片比例")
    image_style: str = Field(default="cartoon", description="图片风格")
    editable_prompts: List[EditablePrompt] = Field(default_factory=list, description="可编辑提示词")
    image_count: int = Field(default=6, description="套图张数")
...
class FinalizeNodeInput(BaseModel):
    ...
    selected_topic: TopicRecord = Field(default_factory=lambda: TopicRecord(title="", audience="", hook="", demand_source="", differentiation=""))
    openai_text_package: TextDescriptionPackage = Field(default_factory=TextDescriptionPackage, description="OpenAI 文案包")
    grok_image_set: ImageSetPackage = Field(default_factory=ImageSetPackage, description="Grok 套图")
    editable_prompts: List[EditablePrompt] = Field(default_factory=list, description="可编辑提示词")
    skill_subflows: List[SkillSubflow] = Field(default_factory=list, description="子流程")
    workflow_steps: List[WorkflowStep] = Field(default_factory=list, description="流程步骤")
