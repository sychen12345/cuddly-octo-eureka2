...
from graphs.state import GrokRulesJudgeInput, GrokRulesJudgeOutput


def grok_rules_judge_node(
    state: GrokRulesJudgeInput,
    ...
    # 构建变更摘要
    changed_items = state.rules_changed_items
    ...
    return GrokRulesJudgeOutput(
        rules_judge_decision=decision,
        rules_judge_reason=reason
    )
